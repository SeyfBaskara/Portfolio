      ...
      <section className="p-4 md:w-11/12 md:m-auto lg:w-4/5">
         <div className="text-white">
            <div className="container  flex flex-col items-start md:flex-row my-12 md:my-24">
               <div className="flex flex-col w-full sticky md:top-36 lg:w-1/3 mt-2 md:mt-12 pr-6">
               ...
               <div className="mt-10 ml-0 md:mt-0 md:ml-12 lg:w-2/3 sticky">
                  <div className="container mx-auto w-full h-full">
                     <div className="relative wrap overflow-hidden h-full">
                        <div className="border-2-2 border-yellow-555 absolute h-full border-2 border-TimelineBorder right-1/2 "></div>
                        <div className="border-2-2 border-yellow-555 absolute h-full border-2 border-TimelineBorder left-1/2 "></div>
                        ...
                        <div className="mb-8 flex justify-between items-center w-full right-timeline">
                           ...
                           <div className="order-1  w-5/12 px-1 py-4 text-left">
                              ...
                              <p className="text-sm md:text-base leading-snug text-gray-50 text-opacity-100">
                                 Participate online. The links for your registered events will be sent to you via email
                                 and whatsapp groups. Use those links and show your talent.
                              </p>
                           </div>
                        </div>
                        <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                           ...
                           <div className="order-1 w-5/12 px-1 py-4 text-right">
                              ...
                              <p className="text-sm md:text-base leading-snug text-gray-50 text-opacity-100">
                                 ...
                                 resukts will be announced on the whatsapp groups and will be mailed to you.
                              </p>
                           </div>
                        </div>
                        ...
                        <div className="mb-8 flex justify-between items-center w-full right-timeline">
                           ...
                           <div className="order-1  w-5/12 px-1 py-4">
                              ...
                              <p className="text-sm md:text-base leading-snug text-gray-50 text-opacity-100">
                                 The winners will be contacted by our team for their addresses and the winning goodies
